...
urlpatterns = [
    ...
    path('meds-tracking/delete/<int:pk>/', views.MedicineDelete.as_view(), name='task_delete'),
    path('meds-tracking/add_reminder/<int:medicine_id>/', views.add_reminder, name='add_reminder'),
    path('meds-tracking/mark-taken/<int:lek_id>/', views.mark_taken, name='mark_taken'),
